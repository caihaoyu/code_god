...
from question_answer.views import QuestionList,QuestionPost,QuestionDetail
...
question_urls=patterns('',
    ...
    url(r'^/search/(?P<title>[0-9a-zA-Z_-]+)$', QuestionList.as_view(), name='question-list')
)
...
urlpatterns = patterns('',
                       ...
                       url(r'^home', 'weekly.views.home', name='home'),
